...
const AmenitieOption = ({ amenitie, setFormData, svg }) => {
  ...
  return (
    <button onClick={handleChange} className="btn flex flex-column align-center justify-center bg-white radius-8 pt4 pb--40 border-gray hover-shadow-black" style={{margin: '0 8px 16px', flex: '0 1 calc(33% - 16px)'}}>
