  ...
  return (
    <svg className={ className } viewBox={ viewBox }>
      <g transform="translate(-31, -30) scale(2, 2)">
        ...
        <path stroke="#222222" strokeLinecap="round" strokeLinejoin="round" fill="none" strokeWidth="2" strokeOpacity="1" d=" M28 34 C28,34 30,34 30,34 C30.55,34 31,34.45 31,35 C31,35 31,45 31,45 C31,45.55 30.55,46 30,46 C30,46 28,46 28,46 C27.45,46 27,45.55 27,45 C27,45 27,35 27,35 C27,34.45 27.45,34 28,34z "></path>
        <path stroke="#222222" strokeLinecap="round" strokeLinejoin="round" fill="none" strokeWidth="2" strokeOpacity="1" d=" M53 40 C53,40 56,40 56,40 "></path>
        <path stroke="#222222" strokeLinecap="round" strokeLinejoin="round" fill="none" strokeWidth="2" strokeOpacity="1" d=" M35 40 C35,40 45,40 45,40 "></path>
        <path stroke="#222222" strokeLinecap="round" strokeLinejoin="round" fill="none" strokeWidth="2" strokeOpacity="1" d=" M24 40 C24,40 27,40 27,40 "></path>
      </g>
    </svg>
  )
}
