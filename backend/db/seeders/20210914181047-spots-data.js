...
module.exports = {
  up: (queryInterface, Sequelize) => {
    return queryInterface.bulkInsert('Spots', [
      ...
      {
        userId: 1,
        title: "The Tiny Cabin - Coral Tree House",
        price: 170,
        address: 'Fake address',
        city: 'Rainbow',
        state: 'California',
        description: "*Owners live on site but do not use common areas when guests are in residence. *There are 2 tiny homes on the property. Both share access to the pool/jacuzzi. *Riley, the world's sweetest dog, lives on the property. *Parents, the pool is unfenced and there are no vertical posts in the stair railings. *To preserve the peaceful atmosphere, and protect the health of guests, only registered guests are allowed on the property.",
        place: 'House',
        type: 'Tiny house',
        space: 'An entire place',
        guests: 4,
